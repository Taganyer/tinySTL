...
template <typename Type> class cIter;

template <typename Type> class Bidirectional_Iter;

template <typename Type> class cBidirectional_Iter;

template <typename Type> class Random_Iter;

template <typename Type> class cRandom_Iter;
...
template <typename Type> class Bidirectional_Iter : public Iter<Type> {
  protected:
  ...
  public:
    ...
    inline friend bool operator==(const Bidirectional_Iter<Type> &left,
                                  const Bidirectional_Iter<Type> &right) {
        return left.target == right.target;
    }
...
template <typename Type> class cBidirectional_Iter : public cIter<Type> {
  protected:
  ...
  public:
    ...
    inline friend bool operator==(const cBidirectional_Iter<Type> &left,
                                  const cBidirectional_Iter<Type> &right) {
        return left.target == right.target;
    }
...
template <typename Type> class Random_Iter : public Bidirectional_Iter<Type> {
  protected:
    using Iter<Type>::target;
  ...
  public:
    ...
    inline friend bool operator==(const Random_Iter<Type> &left,
                                  const Random_Iter<Type> &right) {
        return left.target == right.target;
    }
...
template <typename Type> class cRandom_Iter : public cBidirectional_Iter<Type> {
  protected:
    using cIter<Type>::target;
  ...
  public:
    ...
    inline friend bool operator==(const cRandom_Iter<Type> &left,
                                  const cRandom_Iter<Type> &right) {
        return left.target == right.target;
    }
