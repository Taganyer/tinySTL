...
//----------------------------------------------------------------------------------------------------------------------
    ...
    public:
        ...
        virtual Shared_ptr<cIter<Type>> deep_copy() const { return make_shared<cIter<Type>>(*this); };
...
//----------------------------------------------------------------------------------------------------------------------
    ...
    public:
        ...
        Shared_ptr<Iter<Type>> deep_copy() const override { return make_shared<Bidirectional_Iter<Type>>(*this); };

        Shared_ptr<cIter<Type>> to_const() const override {
            return make_shared<cBidirectional_Iter<Type>>(cBidirectional_Iter<Type>(target));
        };
...
//----------------------------------------------------------------------------------------------------------------------
    ...
    public:
        ...
        Shared_ptr<cIter<Type>> deep_copy() const override { return make_shared<cBidirectional_Iter<Type>>(*this); };
...
//----------------------------------------------------------------------------------------------------------------------
    ...
    public:
        ...
        Shared_ptr<Iter<Type>> deep_copy() const override { return make_shared<Random_Iter<Type>>(*this); };
...
//----------------------------------------------------------------------------------------------------------------------
    ...
    public:
        ...
        Shared_ptr<cIter<Type>> deep_copy() const override { return make_shared<cRandom_Iter<Type>>(*this); };
