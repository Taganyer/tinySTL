  ...
  public:
    ...
    class Iterator : public Random_Iter<char> {
      ...
      public:
        ...
        Shared_ptr<Iter<char>> deep_copy() const override {
            return make_shared<String::Iterator>(*this);
        };
        ...
        friend long long operator-(const Iterator &left,
    ...
    class cIterator : public cRandom_Iter<char> {
      ...
      public:
        ...
        Shared_ptr<cIter<char>> deep_copy() const override {
            return make_shared<String::cIterator>(*this);
        };
        ...
        friend long long operator-(const cIterator &left,
                                   const cIterator &right) {
            return left.target - right.target;
        };
    };
    ...
    class rIterator : public Random_Iter<char> {
      ...
      public:
        ...
        Shared_ptr<Iter<char>> deep_copy() const override {
            return make_shared<String::rIterator>(*this);
        };
        ...
        rIterator operator+(Size size) const {
            return String::rIterator(target - size);
        };
        ...
        friend long long operator-(const rIterator &left,
                                   const rIterator &right) {
    ...
    class crIterator : public cRandom_Iter<char> {
      ...
      public:
        ...
        Shared_ptr<cIter<char>> deep_copy() const override {
            return make_shared<String::crIterator>(*this);
        };
        ...
        crIterator operator+(Size size) const {
            return String::crIterator(target - size);
        };
        ...
        friend bool operator==(const crIterator &left,
    ...
    Iterator insert(Size pos, const char *target, Size target_pos,
                    Size target_len);

    Iterator insert(Size pos, const String &target, Size target_pos = 0,
                    Size target_len = Npos);
    ...
    Iterator insert(const Iterator &iter, const char *target, Size target_pos,
                    Size target_len);

    Iterator insert(const Iterator &iter, const String &target,
                    Size target_pos = 0, Size target_len = Npos);

    Iterator insert(const Iterator &iter, const Iter<char> &begin,
                    const Iter<char> &end);

    Iterator insert(const Iterator &iter, const cIter<char> &begin,
                    const cIter<char> &end);

    cIterator insert(const cIterator &iter, char t, Size size = 1);

    cIterator insert(const cIterator &iter,
                     const std::initializer_list<char> &list);
    ...
    cIterator insert(const cIterator &iter, const char *target, Size target_pos,
                     Size target_len);

    cIterator insert(const cIterator &iter, const String &target,
                     Size target_pos = 0, Size target_len = Npos);

    cIterator insert(const cIterator &iter, const Iter<char> &begin,
                     const Iter<char> &end);

    cIterator insert(const cIterator &iter, const cIter<char> &begin,
                     const cIter<char> &end);

    rIterator insert(const rIterator &iter, char t, Size size = 1);

    rIterator insert(const rIterator &iter,
                     const std::initializer_list<char> &list);
    ...
    rIterator insert(const rIterator &iter, const char *target, Size target_pos,
                     Size target_len);

    rIterator insert(const rIterator &iter, const String &target,
                     Size target_pos = 0, Size target_len = Npos);

    rIterator insert(const rIterator &iter, const Iter<char> &begin,
                     const Iter<char> &end);

    rIterator insert(const rIterator &iter, const cIter<char> &begin,
                     const cIter<char> &end);

    crIterator insert(const crIterator &iter, char t, Size size = 1);

    crIterator insert(const crIterator &iter,
                      const std::initializer_list<char> &list);
    ...
    crIterator insert(const crIterator &iter, const Iter<char> &begin,
                      const Iter<char> &end);

    crIterator insert(const crIterator &iter, const cIter<char> &begin,
                      const cIter<char> &end);
    ...
    String &replace(Size pos, Size len,
                    const std::initializer_list<char> &list);
    ...
    String &replace(Size pos, Size len, const Iter<char> &begin,
                    const Iter<char> &end);

    String &replace(Size pos, Size len, const cIter<char> &begin,
                    const cIter<char> &end);

    String &replace(Size pos, Size len, const String &target, Size target_pos,
                    Size target_len);
    ...
    String &replace(const cIterator &begin, const cIterator &end, Size n,
                    char t);
    ...
    String &replace(const rIterator &begin, const rIterator &end, Size n,
                    char t);
    ...
    String &replace(const crIterator &begin, const crIterator &end, Size n,
                    char t);
